...
function labnolIframe(e) {
  ...
  t.setAttribute(
    "src",
    `https://www.youtube.com/embed/${e.dataset.id}?autoplay=1&rel=0&enablejsapi=1&origin=${window.location.origin}`
  ),
  ...
  umbracoEngage.analytics.video.trackYouTubeVideo(t);
}
